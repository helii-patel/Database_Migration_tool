...
const Settings = () => {
  ...
  const ROLE_INFO = {
    admin: { label: 'Administrator', desc: 'Full access to all features including user management', color: 'text-rose-500', bg: 'bg-rose-50 dark:bg-rose-900/10' },
    engineer: { label: 'Database Engineer', desc: 'Can create connections, run migrations, and view monitoring', color: 'text-primary-500', bg: 'bg-primary-50 dark:bg-primary-900/10' },
    viewer: { label: 'Viewer', desc: 'Read-only access to dashboards and logs', color: 'text-slate-500', bg: 'bg-slate-50 dark:bg-surface-700' },
  };
          ...
          <div className="card p-6 lg:col-span-2">
            ...
            <form onSubmit={handleProfileSave} className="space-y-4">
              ...
              <div>
                ...
                <div className={`input ${roleInfo.bg} ${roleInfo.color} cursor-not-allowed capitalize`}>{user?.role}</div>
      ...
      {activeTab === 'appearance' && (
        <div className="card p-6 max-w-md">
          ...
          <div className="flex items-center justify-between py-4 border-b border-slate-100 dark:border-slate-700">
            ...
            <button id="appearance-theme-toggle"
              onClick={toggleTheme}
